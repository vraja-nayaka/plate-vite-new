...
import { createYjsPlugin } from "@/lib/yjs/src";
...
import {
  createPluntumlPlugin,
  ELEMENT_PLANT_UML,
} from "./plantuml/plugin";
import { PlantumlElement } from "@/components/plate-ui/plant-uml-element";
  ...
  ],
  {
    components: withDraggables(
      withPlaceholders({
        ...
        [ELEMENT_PLANT_UML]: PlantumlElement,
      })
    ),
  }
);
